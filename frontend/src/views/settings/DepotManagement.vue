...
import { useDepotsStore } from '@/stores/depots.js' // Corrected import
...
// Store state
const depotStore = useDepotsStore() // Correctly use the depots store
...
const sortedDepots = computed(() => {
  // Add a guard to ensure depotStore.depots is an array
...
async function saveDepotChanges() {
  ...
  // This action needs to be created in the depotsStore
...
async function saveEquipmentChanges() {
    ...
    // Logic for saving equipment changes needs to be implemented
    // using actions in depotsStore
